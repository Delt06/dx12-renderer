...
PointLightShadowPassPso::PointLightShadowPassPso(const std::shared_ptr<CommonRootSignature>& rootSignature, UINT resolution)
...
ShaderResourceView PointLightShadowPassPso::GetShadowMapShaderResourceView() const
{
...
const std::shared_ptr<Texture>& PointLightShadowPassPso::GetShadowMapsAsTexture() const
{
