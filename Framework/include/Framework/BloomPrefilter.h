...
class BloomPrefilter final : public CompositeEffect
{
public:
	explicit BloomPrefilter(Format backBufferFormat);

	void Execute(CommandList& commandList, const BloomParameters& parameters, const Texture& source, const RenderTarget& destination);
