...
BlitPso::BlitPso(Microsoft::WRL::ComPtr<ID3D12Device2> device, CommandList& commandList, DXGI_FORMAT renderTargetFormat) 
...
void BlitPso::Blit(CommandList& commandList, Texture& source, RenderTarget& destination, UINT destinationTexArrayIndex/*=-1*/)
{
