...
{
	{
		...
		pipelineStateStream.Cs = { buildLuminanceHistogram_Cs, sizeof buildLuminanceHistogram_Cs };
...

	{
		...
		pipelineStateStream.Cs = { averageLuminanceHistogram_Cs, sizeof averageLuminanceHistogram_Cs };
