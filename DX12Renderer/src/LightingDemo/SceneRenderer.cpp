	...
	: m_GraphicsSettings(graphicsSettings)
{
	// Setup RS and PSO
	{
		ComPtr<ID3DBlob> vertexShaderBlob = ShaderUtils::LoadShaderFromFile(L"LightingDemo_VS.cso");
		ComPtr<ID3DBlob> pixelShaderBlob = ShaderUtils::LoadShaderFromFile(L"LightingDemo_PS.cso");
