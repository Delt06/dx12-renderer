...
BrdfIntegrationPso::BrdfIntegrationPso(Microsoft::WRL::ComPtr<ID3D12Device2> device, CommandList& commandList, DXGI_FORMAT renderTargetFormat)
...
void BrdfIntegrationPso::SetContext(CommandList& commandList)
{
...
void BrdfIntegrationPso::SetRenderTarget(CommandList& commandList, RenderTarget& renderTarget)
{
...
void BrdfIntegrationPso::Draw(CommandList& commandList)
{
